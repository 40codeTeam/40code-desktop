...
const manifest = {
  ...
  "description": "向编辑器添加一个新的“调试器”窗口。 允许使用“log”、“warn”和“error”积木登录到调试器窗口的“Logs”选项卡。",
  "tags": ["beta"],
  "info": [{
    "type": "notice",
...
const manifest = {
  "editorOnly": true,
  "name": "Debugger",
  "description": "向编辑器中添加一个新的“调试器”窗口。允许使用“日志”、“警告”和“错误”块登录到调试器窗口的“日志”选项卡。",
  "credits": [{
    "name": "Tacodiva",
...
const manifest = {
  ...
  "info": [{
    ...
    "type": "warning",
    "text": "The \"40code keys\" will only work in 40code, not in Scratch.",
    "id": "twKeysWarn"
  }],
  "settings": [{
    "dynamic": true,
...
const manifest = {
  "editorOnly": true,
  "name": "按名称插入积木",
  "description": "在代码区域上单击鼠标中键，使用 Ctrl+Space 或 Shift+Click 打开一个浮动输入框，您可以在其中键入积木（或积木的一部分）的名称并将积木拖到代码区域中。 拖动时按住 Shift 以避免一次添加多个积木时关闭框。",
  "credits": [{
    "name": "griffpatch"
  }, {
    "name": "TheColaber",
...
const manifest = {
  ...
  "noTranslations": true,
  "name": "一直显示数字键盘",
  "description": "在所有设备（而不仅仅是触摸屏设备）上编辑数字字段时显示 Scratch 的数字键盘输入",
  "credits": [{
    "name": "GarboMuffin"
  }],
  "info": [{
...
const manifest = {
  "editorOnly": true,
  "name": "折叠角色属性",
  "description": "默认情况下隐藏角色属性面板，就像 Scratch 2.0 中一样。 使用当前选定角色上的信息按钮或双击角色以再次显示属性面板。 要重新隐藏它，请使用属性面板中的折叠按钮或双击角色。",
